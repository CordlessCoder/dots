...
M.polish_hl = {
   ...
   Constant = { fg = M.base_30.light_grey, bg = M.base_30.darker_black },
   Character = { fg = M.base_30.light_grey, bg = M.base_30.darker_black },
   TSCharacter = { fg = M.base_30.light_grey, bg = M.base_30.darker_black },
   TSFieldKey = { fg = M.base_30.teal, bg = M.base_30.darker_black },
   Exception = { fg = M.base_30.dark_purple },
   Visual = { fg = M.base_30.white, bg = M.base_30.black2 },
   Delimiter = { fg = M.base_30.teal },
   TSPunctSpecial = { fg = M.base_30.teal },
   TSPunctDelimiter = { fg = M.base_30.teal },
   TSPunctBracket = { fg = M.base_30.teal },
